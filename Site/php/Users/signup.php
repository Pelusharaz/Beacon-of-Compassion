...
<head>
    ...
    <title>Sharaz-Techs| Sign Up</title>
</head>
<body style="background-image: url('../../img/loginbg2.jpg');">
    <style>
        ...
        <div class="picture" style="margin-top:40px;">
            <img src="../../img/log-in.jpg" alt="" height="560px"  width="400px">
        </div>
        <div class="form-information" style="margin-top:40px;">
        <form action="signup.php" method="POST">
        <div class="form-container">
            <div class="container">
                <h1 style="display:flex;"><img src="../../img/profile.png" alt="" width="35"> Join The Tech community </h1>
                <hr><br>
