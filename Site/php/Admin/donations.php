  ...
  <body>
    <header>
      ...
      <div
        ...
        style="background-image: url('../../img/donations.jpg'); height: 550px">
    ...
    <table>
         <th><strong style="color:orange;">Donations</strong></th>
         <tr style="border-radius: 20px;">
             <th>Mode of Payment</td>
             <th>Amount USD</td>
             <th>Frequency Check</td>
             <th>Frequency</td>
             <th>Donor's Name</td>
             <th>Donor's Phone</td>
             <th>Donor's Email</td>
             <th>Wish to be Anonymous</td>
             <th>Comments</td>
             <th>Terms & Conditions</td>
             <th>Date</td>
             <th>Time</td>
             <th>Delete</td>
            <th>Reply</td>
        ...
        <?php
            ...
            ?>
        <tr>
            <td><?php echo "{$row->paymentcheckbox}"; ?></td>
            <td><?php echo "{$row->amount}"; ?></td>
            <td><?php echo "{$row->freqcheckbox}"; ?></td>
            <td><?php echo "{$row->frequency}"; ?></td>
            <td><?php echo "{$row->name}"; ?></td>
            <td><?php echo "{$row->phone}"; ?></td>
            <td><?php echo "{$row->email}"; ?></td>
            <td><?php echo "{$row->anonycheckbox}"; ?></td>
            <td><?php echo "{$row->comment}"; ?></td>
            <td><?php echo "{$row->termscheckbox}"; ?></td>
            <td><?php echo "{$row->Date}"; ?></td>
            <td><?php echo "{$row->Time}"; ?></td>
            <td>
                <form action="deleteproducts.php" method="post" style="box-shadow:none;background-color:transparent;">
                    <input type="hidden" name="deletedonation_id" value="<?php echo "{$row->id}"; ?>">
                    <button type="submit" class="logoutbtn" name="deletedonation_btn">DELETE</button>
                </form>
            </td>
