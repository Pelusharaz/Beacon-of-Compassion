 ...
 if (isset($_POST['addblog'])){
  ...
  $ext = pathinfo($blogimage, PATHINFO_EXTENSION);
   ...
   $target = "blogs/".basename($blogimage);
    ...
    try {
        //code...
        $sql = 'INSERT INTO blogs(blogtitle,dateposted,bloginfo,postedby,blogimage,ext) VALUES(?,?,?,?,?,?) ';
        $sth = $DBH->prepare($sql);
        $sth->execute(array($blogtitle,$dateposted,$bloginfo,$postedby,$blogimage,$ext));
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <strong class="text-dark mr-2">News and Blogs:</strong>
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
      ...
      <fieldset>
        ...
        <div class="columns">
          ...
          <div class="item"style="width:100%">
            <label for="information"> Blog Information<span>*</span></label>
            ...
            <div class="col-lg-4 col-md-12 mb-4">
              <div class="card" >
                ...
                <div class="card-body">
                  ...
                  <div class="date-postedby"><h6 style="float:left;">Author : <?php echo "{$row->postedby}"; ?></h6> <h6 style="float:right;">Date : <?php echo "{$row->dateposted}"; ?></h6></div>
                  <br><br>
