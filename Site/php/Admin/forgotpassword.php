    ...
    <style>
        ...
        <div class="form-container">
            <div class="container">
                ...
                <div class="password">
                    <input type="password" placeholder="Enter new password" name="new-password" id="id_password" required>
                ...
                <button type="submit" name="submit-pass-update" class="registerbtn"style="margin:auto; display:block;">Reset Password</button>
