  ...
  <body>
    <header>
      ...
      <div
        ...
        style="background-image: url('../../img/shopping2.jpg'); height: 550px">
    ...
    <div class="container" style="overflow:scroll; height:900px; max-width:1000px;">
     <table>
         <th><strong style="color:orange;">Shopping Orders</strong></th>
        ...
        <tr>
            ...
            <td>
                <form action="deleteproducts.php" method="post" style="box-shadow:none;background-color:transparent;">
                    <input type="hidden" name="deleteorder_id" value="<?php echo "{$row->id}"; ?>">
                    <button type="submit" class="logoutbtn" name="deleteorder_btn">DELETE</button>
                </form>
            </td>
            <td><a href="mailto:<?php echo "{$row->email}"; ?>?&subject=Subject : Sharaz Techs Shopping Orders&body=Dear <?php echo "{$row->name}"; ?>, " target="_blank"><button type="submit" class="logoutbtn">APPROVE</button></a></td>
            <td><a href="mailto:<?php echo "{$row->email}"; ?>?&subject=Subject : Sharaz Techs Shopping Orders&body=Dear <?php echo "{$row->name}"; ?>, " target="_blank"><button type="submit" class="logoutbtn">DECLINE</button></a></td>
        </tr>
        <?php
         }
        ?>  
