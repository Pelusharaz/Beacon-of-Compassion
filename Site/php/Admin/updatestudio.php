<?php
session_start();
if( $_SESSION['role']!=='Lead Developer' && $_SESSION['role']!=='super admin'){
 ...
 if (isset($_POST['image'])){
  ...
  $image = $_FILES['image']['name'];
   ...
   $target = "studio/".basename($image);
    ...
    try {
        //code...
        $sql = 'INSERT INTO studio(category,gallery,image,Date,Time ) VALUES(?,?,?,Now(),Now() ) ';
        $sth = $DBH->prepare($sql);
        $sth->execute(array($category,$gallery,$image));
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <strong class="text-dark mr-2">sharaz studio:</strong>
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <form action=" " method="POST" style="box-shadow:none;">
                    ...
                    <button class="nav-link" type="submit" name="submit"style="background-color:white;border:none;">Events</button>
                  </form>
                </li>
                <li class="nav-item">
                  <form action=" " method="POST" style="box-shadow:none;">
                    <input type="text" name="search" value="Shoots" style="display:none;">
                    <button class="nav-link" type="submit" name="submit"style="background-color:white;border:none;">Shoots</button>
                  </form>
                </li>
                <li class="nav-item">
                  <form action=" " method="POST" style="box-shadow:none;">
                    <input type="text" name="search" value="Edits" style="display:none;">
                    <button class="nav-link" type="submit" name="submit"style="background-color:white;border:none;">Edits</button>
                  </form>
                </li>
              </ul>
            ...
            <div class="col-lg-4 col-md-12 mb-4">
              <div class="card" style="">
                <div
                  ...
                  <img src="<?php echo "studio/". "{$row->image}";?>"
                  class="img-fluid" style="max-width:300px; height:300px;" />
                  <a href="#!">
                    <div
                      class="mask"
                ...
                <div class="card-body">
                  ...
                  <div class="tools" style="display:flex;margin-left:-40px;">
                    ...
                    <div class="delete-edit" style="margin-left:auto;margin-right:auto;display:block;">
                     <div class="edit" >
                       <button style="margin-top:20px;" class="btn btn-dark " onclick=editproduct()>EDIT PIC</button>
                     </div>
                      <form action="deleteproducts.php" method="post" style="box-shadow:none;">
                        ...
                        <button type="submit" class="btn btn-dark " name="deletepic_btn">DELETE PICTURE</button>
                      </form>
                    </div>
                  </div>
                  <br>
                <div id="cardupdate" class="card-update" style="display:none;">
                  <form action="deleteproducts.php" method="POST" enctype="multipart/form-data" style=" ">
                    <fieldset>
                      <legend style="border-radius:25px; background-color:blue;"><p style="margin:15px;">Edit Pic</p></legend>
                      <div class="columns">
                        <div class="item">
                    ...
                    <div class="item">
                      <label for="cover">Image<span>*</span></label>
