        ...
        <div class="column">
         ...
         <div class="blog" style="margin:20px 10px 0px 10px;padding:30px;text-align:center;center;border-radius:20px;background-color:blue;color:white;">
          ...
          <div class="profile"style="border-radius:50%;width: 165px; height: 165px;background-color:white;margin-left:auto;margin-right:auto;display:block;"><img src="img/sponsors/sponsor1.jpg" alt="profile" style="border-radius:50%;width: 150px; height: 150px;"></div>
           <br>
           <div class="Blog-title"><h4>Rev. Sr. Barbra Adongo</h4></div>
           <div class="Blog-title"><h6 style="color:rgb(238, 81, 8);">FOUNDER & TRUSTEE</h6></div>
           <div class="info"style="margin-left:0px;width:100%;">
             <p>
                Rev. Sr. Barbra Adongo together with the Franciscan Sisters of St. Joseph Asumbi (FSJ) and a Trustee of the Beacon of Compassion Charity Foundation (BCF). She is deeply committed to  community Empowerment, focusing on educational and healthcare initiatives for vulnerable populations.With a degree in hospitality management, Rev. Sr. Barbra combines her organizational skills with a passion for community engagement. As a Trustee, she plays a key role in strategizing impactful programs that empower individuals and strengthen communities.
             </p>
             <a class="btn blogbtn" role="button" href="tel:+254722577374"><i class="fa fa-phone fa-flip-horizontal fa-lg" ></i> Call Now</a>
           </div>
             <!-- Facebook -->
             <a class="btn btn-link btn-floating btn-lg m-1" href="https://www.facebook.com/" target="_blank" role="button" data-mdb-ripple-color="dark" style="color:white;"><i class="fab fa-facebook-f"></i></a>
             <!-- Twitter -->
             <a class="btn btn-link btn-floating btn-lg m-1" href="https://twitter.com/" target="_blank" role="button" data-mdb-ripple-color="dark" style="color:white;"><i class="fab fa-twitter"></i></a>
             <!-- Instagram -->
             <a class="btn btn-link btn-floating btn-lg m-1" href="https://www.instagram.com/" target="_blank" role="button" data-mdb-ripple-color="dark" style="color:white;"><i class="fab fa-instagram"></i></a>
             <!-- whatsapp -->
             <a class="btn btn-link btn-floating btn-lg m-1" href="https://wa.me/+254722577374" target="_blank" role="button" data-mdb-ripple-color="dark" style="color:white;"><i class="fab fa-whatsapp"></i></a>
            </div>
        ...
        <div class="column">
         ...
         <div class="blog" style="margin:20px 10px 0px 10px;padding:30px;text-align:center;center;border-radius:20px;background-color:blue;color:white;">
          <div class="profile"style="border-radius:50%;width: 165px; height: 165px;background-color:white;margin-left:auto;margin-right:auto;display:block;"><img src="img/icons/person.webp" alt="profile" style="border-radius:50%;width: 150px; height: 150px;"></div>
           ...
           <div class="Blog-title"><h6 style="color:rgb(238, 81, 8);">PARTNER</h6></div>
           <div class="info"style="margin-left:0px;width:100%;">
             <p>
